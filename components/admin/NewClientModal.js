...
const fieldClass =
  "w-full rounded-full border border-sage/20 bg-cream px-5 py-3 text-sm text-charcoal outline-none transition placeholder:text-muted/60 focus:border-sage";
const fieldAreaClass =
  "w-full rounded-2xl border border-sage/20 bg-cream px-5 py-3 text-sm text-charcoal outline-none transition placeholder:text-muted/60 focus:border-sage resize-none";
